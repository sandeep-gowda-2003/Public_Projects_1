...
df_movies=pd.read_csv('resources/tmdb_5000_movies.csv')
df_credits=pd.read_csv('resources/tmdb_5000_credits.csv')
...
search_movie=input('Enter the movie name: ').upper()
